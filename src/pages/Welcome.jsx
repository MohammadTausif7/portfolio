        ...
        >
            <div className="container" style={{ padding: "66px 0 34px" }}>
                <div style={{ display: "grid", gap: 18 }}>
                    <div className="kicker">
                        ...
                        <span style={{ opacity: 0.8 }}>Tausif's Portfolio</span>
                    </div>

                    <h1 className="h0">A portfolio that feels like a product.</h1>

                    <p className="p" style={{ maxWidth: 1000, margin: 0 }}>
                        Click on the switch to “power on” the experience. Then enter your name please, and we'll move
                        on to my portfolio.
                    </p>

                    <div className="scrollHint">
                        <span className="kicker" style={{ padding: "7px 12px" }}>
                            <span>⌘</span>
                            <span>Tip</span>
                        </span>
                        <span>
                            Press <b>Enter</b> after typing your name.
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="container" style={{ paddingBottom: 72 }}>
                <div className="card welcomeCard">
                    <div className="featureGrid welcomeGrid">
                        ...
                        <div className="welcomeRight">
                            <div className="cardSoft" style={{ padding: 18, borderRadius: 22, background: "rgba(0,0,0,.22)" }}>
                                <div className="kicker">
                                    <span>{isOn ? "💡" : "🕯️"}</span>
                                    <span>{isOn ? "Powered on" : "Powered off"}</span>
                                </div>
                                <div className="hr" />
                            ...
                            >
                                ...
                                <div style={{ marginTop: 10, display: "grid", gap: 10 }}>
                                    ...
                                    <div
                                        className="small"
                                        style={{
                                            color: error ? "rgba(255,85,85,.92)" : "rgba(255,255,255,.58)",
                                            minHeight: 18,
                                        }}
                                    >
