                ...
                >
                    ...
                    <div className={rightSlot ? "grid2" : ""} style={{ position: "relative" }}>
                        <div>
                            ...
                            <h2 className="h1" style={{ marginTop: kicker ? 14 : 0 }}>{title}</h2>
                            {subtitle ? <p className="p" style={{ marginTop: 10, marginBottom: 0, color: "rgba(255,255,255,.78)" }}>{subtitle}</p> : null}
                            <div className="hr" />
                            <div>{children}</div>
                        </div>
